...
public final class ConfigScreen {
	...
	private static void confirmReset() {
		...
		client.setScreen(new ConfirmResetScreen(client.screen));
	}
	...
	private static void openDictionary(com.aitranslate.client.dictionary.DictionaryManager.Scope scope) {
		Minecraft client = Minecraft.getInstance();
		client.setScreen(new DictionaryScreen(client.screen, scope));
	}

	private static void openDictionary(String directory) {
		Minecraft client = Minecraft.getInstance();
		client.setScreen(new DictionaryScreen(client.screen, directory));
	}
	...
	private static void confirmDictionaryClear(boolean all) {
		Minecraft client = Minecraft.getInstance();
		client.setScreen(new DictionaryCleanupScreen(client.screen, all));
	}
	...
	private static void openPositionScreen() {
		Minecraft client = Minecraft.getInstance();
		client.setScreen(new com.aitranslate.client.display.ButtonPositionScreen(client.screen));
	}
	...
	private static void importIntoContext(String directory) {
		...
		Minecraft client = Minecraft.getInstance();
		client.setScreen(new JsonFilePickerScreen(client.screen, AITranslateModClient.storageRootDir(),
				manager.getRootDir(),
